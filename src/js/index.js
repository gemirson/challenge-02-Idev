...
_avatarMemberA.style.backgroundImage = `url('${linkToAvatarMemberA}')`;
_avatarMemberB.style.backgroundImage = `url('${linkToAvatarMemberB}')`;
_linkGithubMemberA.href = linkToGithubMemberA;
_linkGithubMemberB.href = linkToGithubMemberB;
